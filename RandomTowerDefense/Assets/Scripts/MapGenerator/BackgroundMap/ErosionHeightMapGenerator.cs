...
using UnityEngine;
public class ErosionHeightMapGenerator : MonoBehaviour {
    ...
    float[] GenerateHeightMapGPU (int mapSize) {
        ...
        int threadGroups = Mathf.CeilToInt(map.Length / (float)threadGroupSize);
        heightMapComputeShader.Dispatch (0, threadGroups, 1,1);
