...
public class ErosionTerrainGenerator : MonoBehaviour {
    ...
    ErosionHeightMapGenerator heightMapGenerator;
    int[] randomIndices;
    int mapSizeOld;
    ...
    void OnValidate () {
        if (Application.isPlaying) {
            heightMapGenerator = FindObjectOfType<ErosionHeightMapGenerator> ();
            SettingsChanged ();
        }
    }
    ...
    public void GenerateHeightMap () {
        if (heightMapGenerator == null) {
            heightMapGenerator = GetComponent<ErosionHeightMapGenerator> ();
        }
