...
namespace LinearAlgebra
{
    ...
    public struct Matrix3x3d
    {
        ...
        /// </summary>
        public Matrix3x3d(float m00, float m01, float m02,
        ...
        /// </summary>
        public static Matrix3x3d operator *(Matrix3x3d m1, float s)
        {
            Matrix3x3d kProd = new Matrix3x3d();
            kProd.m00 = m1.m00 * s;
            kProd.m01 = m1.m01 * s;
        ...
        /// Create a scale out of a vector.
        /// </summary>
        static public Matrix3x3d Scale(float s)
        {
        ...
        /// </summary>
        static public Matrix3x3d RotateX(float angle)
        {
        ...
        /// Create a rotation out of a angle.
        /// </summary>
        static public Matrix3x3d RotateY(float angle)
        {
            float ca = Mathf.Cos(angle * Mathf.PI / 180.0f);
            float sa = Mathf.Sin(angle * Mathf.PI / 180.0f);
        ...
        /// Create a rotation out of a angle.
        /// </summary>
        static public Matrix3x3d RotateZ(float angle)
        {
            float ca = Mathf.Cos(angle * Mathf.PI / 180.0f);
            float sa = Mathf.Sin(angle * Mathf.PI / 180.0f);
