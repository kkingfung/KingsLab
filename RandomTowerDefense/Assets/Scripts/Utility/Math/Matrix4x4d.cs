...
namespace LinearAlgebra
{
    ...
    public struct Matrix4x4d
    {
        ...
        /// </summary>
        public Matrix4x4d(float m00, float m01, float m02, float m03,
        ...
        /// </summary>
        public static Matrix4x4d operator *(Matrix4x4d m1, float s)
        {
            Matrix4x4d kProd = new Matrix4x4d();
            kProd.m00 = m1.m00 * s;
            kProd.m01 = m1.m01 * s;
        ...
        /// </summary>
        static public Matrix4x4d TranslateRotateScale(Vector3 t, Quaternion3d r, Vector3 s)
        {
        ...
        /// </summary>
        static public Matrix4x4d TranslateRotate(Vector3 t, Quaternion3d r)
        {
            Matrix4x4d T = Translate(t);
            Matrix4x4d R = r.ToMatrix4x4d();
        ...
        /// </summary>
        static public Matrix4x4d TranslateScale(Vector3 t, Vector3 s)
        {
            Matrix4x4d T = Translate(t);
            Matrix4x4d S = Scale(s);
        ...
        /// </summary>
        static public Matrix4x4d RotateScale(Quaternion3d r, Vector3 s)
        {
            Matrix4x4d R = r.ToMatrix4x4d();
            Matrix4x4d S = Scale(s);
        ...
        /// Create a scale out of a vector.
        /// </summary>
        static public Matrix4x4d Scale(float s)
        {
        ...
        /// </summary>
        static public Matrix4x4d RotateX(float angle)
        {
        ...
        /// Create a rotation out of a angle.
        /// </summary>
        static public Matrix4x4d RotateY(float angle)
        {
            float ca = Mathf.Cos(angle * Mathf.PI / 180.0f);
            float sa = Mathf.Sin(angle * Mathf.PI / 180.0f);
        ...
        /// Create a rotation out of a angle.
        /// </summary>
        static public Matrix4x4d RotateZ(float angle)
        {
            float ca = Mathf.Cos(angle * Mathf.PI / 180.0f);
            float sa = Mathf.Sin(angle * Mathf.PI / 180.0f);
        ...
        /// </summary>
        static public Matrix4x4d Perspective(float fovy, float aspect, float zNear, float zFar)
        {
            float f = 1.0f / Mathf.Tan((fovy * Mathf.PI / 180.0f) / 2.0f);
        ...
        /// </summary>
        static public Matrix4x4d Ortho(float xRight, float xLeft, float yTop, float yBottom, float zNear, float zFar)
        {
            float tx, ty, tz;
        ...
        /// </summary>
        static public Matrix4x4d LookAt(Vector3 position, Vector3 target, Vector3 Up)
        {
